...
- (void)setHeadersforResponse:(WGCDWebServerResponse*)response opts:(NSDictionary*) opts {
...
- (void)respondInternalWithRequestId:(NSString *) requestId response:(WGCDWebServerResponse*)response opts:(NSDictionary*) opts {
    [self setHeadersforResponse:response opts: opts];
